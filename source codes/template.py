...
def get_convolution_using_fourier_transform(image, kernel):
    ...
    image_copy = np.fft.ifft2(conv_fft).real
    return image_copy
...
def task1():
    ...
    fft_result = get_convolution_using_fourier_transform(image,
                                                         kernel)  # get_convolution_using_fourier_transform(image, kernel)
